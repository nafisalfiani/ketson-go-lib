...
func shortFuncName(f *runtime.Func) string {
	...
	// - "github.com/nafisalfiani/ketson-go-lib/<package>.<FuncName>"
	// - "github.com/nafisalfiani/ketson-go-lib/<package>.<Receiver>.<MethodName>"
	// - "github.com/nafisalfiani/ketson-go-lib/<package>.<*PtrReceiver>.<MethodName>"
	longName := f.Name()
